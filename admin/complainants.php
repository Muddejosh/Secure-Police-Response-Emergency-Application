			...
			<div class="col-md-12">
				<div class="card shadow-sm">
					<div class="card-header bg-dark">
						<b style="color:white">List of Complainants</b>
					</div>
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
									<?php if($row['status'] == 1): ?>
										<button class="btn  btn-outline-danger unverify_user" type="button" data-id="<?php echo $row['id'] ?>" >Unverify</button>
									<?php else: ?>
										<button class="btn  btn-outline-success verify_user" type="button" data-id="<?php echo $row['id'] ?>" >Verify</button>
									<?php endif; ?>
										<button class="btn  btn-outline-primary view_complaints" type="button" data-id="<?php echo $row['id'] ?>"   data-name="<?php echo $row['name'] ?>">View Complaints</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
