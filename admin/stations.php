			...
			<div class="col-md-12">
				<div class="card shadow-sm">
					<div class="card-header bg-dark">
						<b style="color:white">List of Stations</b>
						<span class="float:right"><a class="btn btn-outline-light btn-block col-sm-2 float-right" href="javascript:void(0)" id="new_station">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn  btn-outline-primary edit_station" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn  btn-outline-danger delete_station" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
