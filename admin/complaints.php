...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="card-header bg-dark">
						<b style="color:white">List of Reports of Complaints</b>
					</div>
			<div class="card-body">
			        ...
			        <tbody>
			          ...
			          <tr class="<?php echo $row['status'] == 1 ? 'border-alert' : '' ?>">
			            ...
			            <td class="text-center">
			            	<button class="btn btn-primary m-0 view_btn" type="button" data-id="<?php echo $row['id'] ?>">View</button>
			            </td>
			          </tr>
			        <?php endwhile; ?>
			        </tbody>
